...
$sendEmail->setServer('smtp.qq.com', '892171962@qq.com', 'isfwdhqngydhbbeh', 465, true);
$sendEmail->setFrom('892171962@qq.com'); // 设置发件人
$sendEmail->setReceiver('1021298862@qq.com');// 设置收件人
$sendEmail->setMail('这是邮件标题', '内容我随便写一点');// 设置邮件主题和内容
$result = $sendEmail->sendEmail(); // 发送邮件
if (!$result) {
    $errorMsg = $sendEmail->error();
} else {
    $errorMsg = '发送成功';
}
